...
def gen():
    # Access the webcam or video source (0 is for the default camera)
...
def video_1():
    # Use Response to display the video stream using the generator function
...
#     df_mean.to_csv('static/js/db/text_mean.tx, sep=',', index=False)
